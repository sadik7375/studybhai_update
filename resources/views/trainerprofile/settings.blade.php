                ...
                <div class="profile-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 personal-info">
                            ...
                            <form method="POST" action="{{ route('trainer.profileupdate') }}">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <label class="col-lg-1 1control-label"><b>Institute Name:</b></label>
                                    <div class="col-lg-4">
                                        @if(auth()->user()->profile)
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-lg-1 control-label"><b>Address:</b></label>
                                    <div class="col-lg-4">
                                        @if(auth()->user()->profile)
