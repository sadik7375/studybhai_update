...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
    ...
    <div class="sidebar-brand-text mx-3">Trainer Profile</div>
</a>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="{{route('trainer.assigncourses')}}" data-target="#Orders" aria-expanded="true"
       aria-controls="collapseTwo">
        <i class="fas fa-fw fa-cog"></i>
